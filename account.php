...
<title> PLACEMENT TEST YOUR SKILL </title>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/deepak.jpg" width=100 height=100 alt="Deepak saroj" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Hi</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+917985460924</h4>
		<h4 style="font-family:'typo' ">depaksr2056@gmail.com</h4>
		<h4 style="font-family:'typo' ">Sistec</h4></div></div>
		</p>
      </div>
